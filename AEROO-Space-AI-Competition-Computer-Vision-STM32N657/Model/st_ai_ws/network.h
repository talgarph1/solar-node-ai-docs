...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "best_full_integer_quant"
...
// Output buffer 1 -- Transpose_569_out_0
#define LL_ATON_DEFAULT_OUT_1_ALIGNMENT   (32)
#define LL_ATON_DEFAULT_OUT_1_SIZE_BYTES  (16800)
